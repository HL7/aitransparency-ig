...
* category contains AImodelCard 1..*
...
* content.attachment.data 0..1 MS
  * ^comment = "The model-card in base64-encoded text format"
* content.attachment.url 0..1 MS
  * ^comment = "The model-card as a URL"
* identifier 0..* MS
* description 0..1 MS 
  * ^comment = "The model-card in markdown format"
...
* contact.system = #url
* contact.value = "http://example.org"
* extension[modelCardDescription].valueReference = Reference(DocumentReference/ModelCard-sample-datasetcard-simple)
...
* #Artificial-Intelligence "All kinds of Artificial Intelligence"